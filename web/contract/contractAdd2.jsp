...
<div class="padding">
    <form method="post" action="/DZOMS/contract/contractWrite" class="form-inline" style="width: 100%">
        ...
        <s:else>
            <s:hidden name="contract.planMaked" value="true"></s:hidden>
        </s:else>
        <div class="panel">
                    ...
                    <div class="xm10">
                        ...
                        <div class="form-group">
                            ...
                            <div class="field">
                                ...
                                <s:textfield cssClass="input datepick" id="startdate" onBlur="set_date()"
                                             name="contract.contractBeginDate"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="label padding">
                            ...
                            <div class="field">
                                <s:textfield cssClass="input datepick" id="enddate" onchange="dateRefresh()"
                        ...
                        <div class="form-group">
                            ...
                            <div class="field">
                                <s:textfield cssClass="input " name="contract.discountDays" value="4"
                        ...
                        <div style="width: 100%">
                            ...
                            <div class="form-group margin-small">
                                <div>
                                    <a id="add_rent_but" class="button dialogs  float-left" data-toggle="click"
                                       data-target="#mydialog" data-mask="1" data-width="50%">添加</a>
                                    <a class="button input-file " href="javascript:void(0);"
                                       onclick="delRentPlan()">删除</a>
                                </div>
                                <div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="field">
                                <s:textfield type="text" name="contract.feeAlter" cssClass="input"
                                             value="%{@com.dz.common.other.ObjectAccess@getObject('com.dz.module.driver.Driver',contract.idNum).fuwubaozhengjin}"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="label padding">
                        ...
                        <s:if test="%{contract.contractFrom!=null}">
                            <div>
                                ...
                                <div>
                                    ...
                                    <s:if test="%{contract.contractFrom!=null}">
                                        <s:textfield
                                                value="%{@com.dz.common.other.ObjectAccess@getObject('com.dz.module.contract.Contract',contract.contractFrom).carNum}"></s:textfield>
                                    </s:if>
                                </div>
                            </div>
                        </s:if>
    ...
    <div class="line" style="overflow: auto;">
        <table class="table table-bordered table-hover m10" id="plan">
            <tr></th>
                <th colspan=14 onclick='tablehide()'>
                    <h4 id='head'><p>隐藏制定计划</p></h4>
                </th>
            </tr>
            <tr class='hide'>
                <th></th>

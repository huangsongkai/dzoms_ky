                ...
                <div class="line">
                    ...
                    <div class="xm10">
                        ...
                        <div class="form-group">
                            ...
                            <div class="field" >
                                <s:radio name="contract.ascription" list="%{#{'false':'公司','true':'个人'}}"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="field" >
                                <s:textfield cssClass="input" readonly="true" id="startdate" name="contract.contractBeginDate" />
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="label padding">
                            ...
                            <div class="field" >
                                <s:textfield cssClass="input" id="enddate" readonly="true" name="contract.contractEndDate" />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="field">
                                <s:textfield cssClass="input " name="contract.discountDays"></s:textfield>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="field" >
                                <s:textfield cssClass="input" name="rentFirst_Month" value="96" readonly="true"/>
                                <input type="hidden" name="rentFirst_MonthEach" />
                            </div>
                        </div>
                        <br />
                        ...
                        <div  style="width: 100%">
                            ...
                            <div class="form-group margin-small">
                                <div>
                                    <a id="add_rent_but"  class="button dialogs  float-left" style="display: none;" data-toggle="click" data-target="#mydialog" data-mask="1" data-width="50%">添加</a>
                                    <a class="button input-file " style="display: none;"  href="javascript:void(0);" onclick="delRentPlan()">删除</a>
                                </div>
                                <div>

                                </div>
                                <div>
                                    <a class="button input-file " style="display: none;" href="javascript:void(0);" onclick="geneRentPlan()">生成租金计划</a>
                                </div>
                            </div>
                        </div>
                        <br>
                        ...
                        <div class="form-group">
                            ...
                            <div class="field" >
                                <s:textfield type="text" name="contract.feeAlter" cssClass="input"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="label padding">
                        ...
                        <s:if test="%{contract.contractFrom!=null}">
                            <div>
                                ...
                                <div>
                                    ...
                                    <s:if test="%{contract.contractFrom!=null}">
                                        <s:textfield readonly="true" value="%{@com.dz.common.other.ObjectAccess@getObject('com.dz.module.contract.Contract',contract.contractFrom).carNum}"></s:textfield>
                                    </s:if>
                                </div>
                            </div>
                        </s:if>
                        ...
                        <div class="form-group">
                            ...
                            <div class="field" >
                                <s:select readonly="true" cssClass="input" name="driver.sex"
                        ...
                        <div class="form-group">
                            ...
                            <div class="field" >
                                <s:textfield readonly="true" cssClass="input"  name="driver.phoneNum1" />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="field" >
                                <s:textfield cssClass="input" readonly="true"  name="driver.drivingLicenseNum" />
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="label padding">
                            ...
                            <div class="field" >
                                <s:textfield cssClass="input"  readonly="true" name="driver.qualificationNum" />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="field" >
                                <s:textfield cssClass="input input-auto" size="40" readonly="true" name="driver.accountLocation" />
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="label padding">
                        ...
                        <div class="form-group">
                            ...
                            <div class="field" >
                                <s:textfield cssClass="input input-auto" size="40" readonly="true"  name="driver.address" />
                            </div>
                        </div>

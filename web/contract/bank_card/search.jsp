...
<div class="line">
	<div class="panel  margin-small" >
		...
		<div class="panel-body">
			<form method="post" class="form-inline" id="search_form" action="searchCard" target="result_form">
				<table class="table">
					...
					<div class="form-group">
						<div class="label"><label>银行卡类别</label></div>
						<div class="field">
							<select name="bankCard.cardClass" class="input input-auto">
					...
					<div class="form-group">
						...
						<div class="field">
							<select name="dept" class="input input-auto">
...
<div>
	<iframe name="result_form" width="100%" height="1500px" scrolling="yes">

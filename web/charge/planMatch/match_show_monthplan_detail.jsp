...
%>
<%
	int monthPlanId = toInt(request.getParameter("monthPlanId"));
	MonthPlan monthPlan = ObjectAccess.getObject(MonthPlan.class,monthPlanId);
	Vehicle vehicle = null;

	List<IncomeDivide> divides = Collections.emptyList();
	
	vehicle = ObjectAccess.getObject(Vehicle.class,monthPlan.getCarframeNum());
	Session hsession = HibernateSessionFactory.getSession();
   if (monthPlan!=null){
       Query query1 = hsession.createQuery("from IncomeDivide " +
               "where monthPlanId=:monthPlanId and type=0 ");
       query1.setInteger("monthPlanId",monthPlanId);
       divides = query1.list();
   }
%>
<!DOCTYPE html>

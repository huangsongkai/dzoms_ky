 ...
 %>
			<s:if test="%{meeting.meetingTimeL1!=null}">
				<tr>
					...
					<td>
						<%int leaveNum = 0;//md.selectLeaveNumber(meeting.getId(), "一部");
						int manualLeave = md.selectMeetingCheckCount(meeting.getId(),condition_dept1,conditon_manaul_leave);
					...
					<td>
						<%
							/*当日人数*/
						List<MeetingCheck> dangriList = md.selectMeetingCheck(meeting.getId(),condition_dept1,conditon_checked,conditon_not_dangri,conditon_not_spacial,conditon_not_manaul_leave);
					...
					<td>
					<% 
					List<MeetingCheck> shidaoList = md.selectMeetingCheck(meeting.getId(),condition_dept1,conditon_checked,conditon_not_dangri,conditon_not_spacial,conditon_not_manaul_leave);
			...
			<s:if test="%{meeting.meetingTimeL2!=null}">
				<tr>
					...
					<td>
						<%int leaveNum = 0;//md.selectLeaveNumber(meeting.getId(), "二部");
							int manualLeave = md.selectMeetingCheckCount(meeting.getId(),condition_dept2,conditon_manaul_leave);
							leaveNum += manualLeave;
					...
					<td>
						<%
						@SuppressWarnings({"unchecked" })
						List<MeetingCheck> dangriList = md.selectMeetingCheck(meeting.getId(),condition_dept2,conditon_checked,conditon_not_dangri,conditon_not_spacial,conditon_not_manaul_leave);
					...
					<td>
					<% 
					List<MeetingCheck> shidaoList = md.selectMeetingCheck(meeting.getId(),condition_dept2,conditon_checked, conditon_not_dangri,conditon_not_spacial,conditon_not_manaul_leave);
			...
			<s:if test="%{meeting.meetingTimeL3!=null}">
				<tr>
					...
					<td>
						<%int leaveNum = 0;//md.selectLeaveNumber(meeting.getId(), "三部");
							int manualLeave = md.selectMeetingCheckCount(meeting.getId(),condition_dept3,conditon_manaul_leave);
							leaveNum += manualLeave;
					...
					<td>
						<%
						List<MeetingCheck> dangriList = md.selectMeetingCheck(meeting.getId(),condition_dept3,conditon_checked,conditon_not_dangri,conditon_not_spacial,conditon_not_manaul_leave);
					...
					<td>
					<% 
					List<MeetingCheck> shidaoList = md.selectMeetingCheck(meeting.getId(),condition_dept3,conditon_checked, conditon_not_dangri,conditon_not_spacial,conditon_not_manaul_leave);
		...
		<div class="panel  margin-small" >
          	...
          	<div class="panel-body">
				...
				<div class="">
					...
					<table class="table table-bordered table-hover fieldset" id="meeting-time-detail">
						<tr>

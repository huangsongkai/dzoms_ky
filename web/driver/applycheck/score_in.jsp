...
<div class="panel magrin">
	 <blockquote class="border-main">
        <strong>运营部经理审批</strong>
        <form method="post" action="/DZOMS/driver/driverAppendScore">
            <label>分数</label><input name="driver.score" class="input">
            <label>运营部经理意见</label><input name="driver.bangonshifuzerenyijian"  class="input "/>
            <s:hidden value="%{#session.user.uname}" name="driver.bangonshifuzeren"/>
...
<%--<body>--%>
    ...
    <%--</iframe>--%>
    <%--<form method="post" action="/DZOMS/driver/driverAppendScore">--%>
        <%--<label>分数</label><input name="driver.score">--%>
        <%--<label>运营部经理意见</label><input name="driver.bangonshifuzerenyijian">--%>
        <%--<s:hidden value="%{#session.user.uname}" name="driver.bangonshifuzeren"/>--%>
        <%--<s:hidden value="%{driver.idNum}" name="driver.idNum"/>--%>
        <%--<input type="submit">--%>
    <%--</form>--%>

    ...
    function setProperty(id){
      ...
      $.post('/DZOMS/accident_SelectById',dat,function(data){
        ...
        setVehicle(list["carId"]);
          //checker and payer
          var dap = {"className":"com.dz.module.user.User","id":list["checker"]};
          $.post('/DZOMS/common/getObject',dap,function(data){
              $("#checker").attr("value",data["uname"]);
          });
          $("#payer").attr("value",list["payer"]);
          $("#checkTime").attr("value",list["check_time"]["$"]);
          $("#payTime").attr("value",list["pay_time"]["$"]);
...
<div class="line">
  ...
  <blockquote>
  	 ...
  	 <table class="table" style="width: auto;">
  	 	<tr>
  	 		 <td>复核时间</td>
  	 		 <td> <input class="input input-auto"  type="text" readonly="readonly" id="checkTime"></td>
  	 		  <td>复核经手人</td>
  	 		 <td><input class="input input-auto"  type="text" readonly="readonly" id="checker"></td>
  	 	</tr>
  	 </table>
  </blockquote>
  <blockquote>
  	<strong>赔付</strong>
  	 <table class="table"  style="width: auto;">
  	 	<tr>
  	 		 <td>赔付时间</td>
  	 		 <td><input class="input input-auto"  type="text" readonly="readonly" id="payTime"></td>
  	 		  <td>赔付经手人</td>
  	 		 <td><input class="input input-auto"  type="text" readonly="readonly" id="payer"></td>
  	 	</tr>
  	 </table>
  </blockquote>

                ...
                <div class="form-group">
                    ...
                    <div class="field">
                        <s:textfield id="insuranceNum" cssClass="input" placeholder=""
                                     name="insurance.insuranceNum" value="%{bean[0].insuranceNum}" data-validate="required:请选择,regexp#(^(PDAA|PDZA|PZDS)[A-Z0-9]{18}$):格式不正确(22位，交强险以PDZA开头，商险以PDAA开头，承运人责任险以PZDS开头)"/>
                    </div>
                </div>
                <div class="form-group">
                    <div class="label">

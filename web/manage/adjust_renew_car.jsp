...
$(document).ready(function(){
	$("input[type='text'],textarea").attr("disabled",true);
		...
		l = '<s:property escape="false" value="%{old_contract.planList}"/>';
		l = $.parseJSON(l);
		for(var i=0;i<l.length;i++){
			var beginTime = l[i]["begin"];
			var endTime = l[i]["end"];
			...
			<div class="panel xm6 my-top-panel">
				...
				<div class="panel-body">
					<div class="form-group">
						...
						<div class="field">
							<s:textfield  name="old_contract.contractBeginDate" cssClass="input input-auto datepick"  >
								<s:param name="value">
			                		<s:date name="%{old_contract.contractBeginDate}" format="yyyy/MM/dd"></s:date>
			                	</s:param>
			                </s:textfield>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="field">
							<s:textfield  name="old_contract.contractEndDate" cssClass="input input-auto datepick" >
								<s:param name="value">
			                		<s:date name="%{old_contract.contractEndDate}" format="yyyy/MM/dd"></s:date>
			                	</s:param>
			                </s:textfield>
						</div>
					</div>
					<div class="form-group need_change">
						...
						<div class="field">
                			<select  id="old_rentList" size="5" style="width: 400px;"  class="float-left">
					...
					<div class="form-group need_change">
						...
						<div class="field">
							<s:textfield value="%{@com.dz.common.other.ObjectAccess@getObject('com.dz.module.user.User',old_contract.inputer).uname}" cssClass="input input-auto"  />
						</div>
					</div>
					<div class="form-group need_change">
						<div class="label"><label>合同录入日期</label></div>
						<div class="field">
							<s:textfield  name="old_contract.inputTime" cssClass="input input-auto datepick" >
								<s:param name="value">
			                		<s:date name="%{old_contract.inputTime}" format="yyyy/MM/dd HH:mm:ss"></s:date>
			                	</s:param>
			                </s:textfield>
						</div>
					</div>
...
<div class="xm12">
		...
		<div class="panel" style="min-height: 400px;">
			...
			<div class="panel-body">
			<form action="/DZOMS/adjustNewCar" id="myform2" method="post" class="form-x form-tips">
			
			<div class="panel xm6 need_change">
				<div class="panel-head">
				财务约定调整
				</div>
				<div class="panel-body">
					<s:if test="#request.old_personal_list!=null&&#request.old_personal_list.size()>0">
					<div class="form-group">
						<div class="field" style="width: 100%;">
							<table class="table table-hover table-striped table-bordered">
							<thead>
								<tr>
									<th colspan="7">人工录入的约定</th>
								</tr>
							<tr>
							...
							<tbody>
								<s:iterator value="%{#request.old_personal_list}" var="v">
									<tr>
										<td>
					...
					<s:if test="#request.old_auto_list!=null&&#request.old_auto_list.size()>0">
					<div class="form-group">
						<div class="field" style="width: 100%;">
							<table class="table table-hover table-striped table-bordered">
							<thead>
								<tr>
									<th colspan="6">自动生成的约定</th>
								</tr>
							<tr>
							...
							<tbody>
								<s:iterator value="%{#request.old_auto_list}" var="v">
									<tr>
										<td>
										<s:property value="%{#request.mp[#v.feeType]}"/>
										</td>

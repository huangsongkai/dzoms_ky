	...
	<div class="xm12">
		...
		<div class="panel" style="min-height: 400px;">
			...
			<div class="panel xm6 my-top-panel" >
				...
				<div class="panel-body">
					<div class="form-group">
						<div class="label"><label>废业办理日</label></div>
						<div class="field">
							<s:textfield  name="contract.abandonedTime" cssClass="input input-auto  datepick"   >
								<s:param name="value">
					...
					<div class="form-group need_change">
						<div class="label"><label>废业办结日</label></div>
						<div class="field">
							<s:textfield value="%{contract.abandonedFinalTime}" cssClass="input input-auto"   />
						</div>
					</div>
					<div class="form-group need_change">
						<div class="label"><label>计费截止日期</label></div>
						<div class="field">
							<s:textfield  name="contract.abandonedChargeTime" cssClass="input input-auto datepick"   >
								<s:param name="value">
			                		<s:date name="%{contract.abandonedChargeTime}" format="yyyy/MM/dd"></s:date>
			                	</s:param>
			                </s:textfield>
						</div>
					</div>

...
public class JobDutyController {
    ...
    @ResponseBody
    public Result saveMyEvaluate(@PathVariable Integer taskId, @RequestBody SaveEvaluateDTO saveEvaluateDTO, HttpServletRequest request) throws Exception {
        HttpSession session = request.getSession();
        User user = (User) session.getAttribute("user");
        return jobDutiesService.saveMyEvaluate(saveEvaluateDTO, user.getUid(), taskId);
    }
    ...
    @ResponseBody
    public Result saveManagerEvaluate(@PathVariable Integer taskId, @RequestBody SaveEvaluateDTO saveEvaluateDTO, HttpServletRequest request) throws Exception {
        return jobDutiesService.saveManagerEvaluate(saveEvaluateDTO, request, taskId);
    }
    /**
     * 考评历史信息
     * historyxinxi
